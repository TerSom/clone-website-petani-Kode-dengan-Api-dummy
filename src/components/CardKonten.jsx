const CardKonten = () => {
  return (
    <div className="">
      <div className="bg-slate-900 h-[500px] w-full flex justify-center text-white">
        <div className="w-[92%] h-[300px] mt-20">
          ...
          <div className=" h-full items-center grid grid-cols-3 gap-6">
            <div className="bg-slate-800 h-[74%]  rounded-2xl items-center justify-center flex cursor-pointer">
              <div className=" w-[85%] h-[80%] flex flex-col gap-3">
                ...
                <h1 className="font-bold">Basic Programming</h1>
            ...
            <div className="bg-slate-800 h-[74%] rounded-2xl items-center justify-center flex">
              <div className=" w-[85%] h-[80%] flex flex-col gap-3">
                ...
                <h1 className="font-bold">Web Programming</h1>
                <p className="font-light">
            ...
            <div className="bg-slate-800 h-[74%] rounded-2xl items-center justify-center flex">
              <div className=" w-[85%] h-[80%] flex flex-col gap-3">
                ...
                <h1 className="font-bold">Tutorial lainya</h1>
                <p className="font-light">
      ...
      <div className="bg-slate-900 h-full w-full flex justify-center text-white">
            <div className="w-[92%] flex flex-col gap-3">
                    <p className="font-bold uppercase text-teal-600 dark:text-teal-400 text-sm">Update</p>
                    <h1 className="font-bold text-[28px]">Apa yang baru di Petani Kode? 🔥</h1>
                    <p className="text-lg  text-slate-500 font-medium">Baca artikel terbaru yang masih fresh dan hangat.</p>
            </div>
        </div>
    </div>
  );
